...
impl GetRequest {
    fn new(message_id: String, filter: Option<GetFilter>) -> Self {
        Self {
            message_id,
    ...
    pub fn new_request_str(message_id: String, filter: Option<GetFilter>) -> Result<String> {
...
// Needed because of quick-xml inability to serialize our structure properly for enum (String only).
